...
public class PP_16_Point {
    ...
    public PP_16_Point(int x, int y) {
        this.x = x;
        this.y = y;
    }
    ...
    public double distance(PP_16_Point secondPoint) {
    ...
    public static void main(String[] args) {
        ...
        PP_16_Point first = new PP_16_Point(6, 5);

        PP_16_Point second = new PP_16_Point(3, 1);
        ...
        PP_16_Point point = new PP_16_Point();
